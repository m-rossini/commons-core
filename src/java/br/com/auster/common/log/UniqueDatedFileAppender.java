 ...
 */
public class UniqueDatedFileAppender extends FileAppender {
	 ...
	 * </ul>
	 */
	public UniqueDatedFileAppender() {
	 ...
	 *          the suffix that is added to log file filenames.
	 */
	public UniqueDatedFileAppender(String directory, String prefix, String suffix) {
		aThreadId = Long.toString(Thread.currentThread().getId()) + separator + (this.hashCode() + Calendar.getInstance().getTimeInMillis());
	...
	public void append(LoggingEvent event) {
		...
		if (n >= m_tomorrow) {
			...
			m_tomorrow = m_calendar.getTime().getTime(); // time in milliseconds when
																										// tomorrow starts
			File newFile = new File(m_path, m_prefix  + datestamp + separator + aThreadId  + m_suffix);
